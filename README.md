...
An attempt at following the LearnOpenGL tutorial while also writing clean and modern C++ code.
...
meson setup --buildtype=debug --native-file=builddir/conan_meson_native.ini -Db_sanitize=address . builddir/debug
